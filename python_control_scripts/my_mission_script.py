...
class CustomController:
    ...
    def position_control(self, positions, vel_lin, vel_ang):
...
def parsePositions():
    ...
    return pos, args.linear_velocity, args.angular_velocity
...
if __name__ == '__main__':
    """
    Sample call:
        $python2.7 my_mission_script.py --positions 10 10 10 50 50 20 50 -50 20 -50 -50 20 0 0 20 --linear_velocity 5 --angular_velocity 5
    ...
    with linear velocity of 5 and angular velocity of 5.
    """
    try:
        positions, vel_lin, vel_ang = parsePositions()
        customController = CustomController()
        customController.checkForServices()
        customController.checkForTopics()
        customController.checkForFCU()
        customController.position_control(positions, vel_lin, vel_ang)
